...
public class calcoptforcust{
    ...
    public static void main(String[] args) {
      ...
      for(int i=1;i<=10;i++)
      {
          sql="select avg(P"+i+") from cust"+cust+"_monthly_sum";
      ...
      {
          sql="select * from cust"+cust+"_monthly_sum where month="+month+"";
          ResultSet rs=stmt.executeQuery(sql);
          rs.next();          
          ...
          sql="insert into optforcust"+cust+" values ("+month+","+c[0]+","+c[1]+","+c[2]+","+c[3]+","+c[4]+","+c[5]+","+c[6]+","+c[7]+","+c[8]+","+c[9]+")";
